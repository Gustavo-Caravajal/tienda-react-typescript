...
const IMGBB_API_KEY: string = "c71a3dc520350d631d7fb20e52c5c174"; //👈reemplazan por la suya
const ENDPOINT: string = "https://api.imgbb.com/1/upload";
...
export const fileToBase64 = (file: File): Promise<string> => {
  return new Promise<string>((resolve, reject) => {
    ...
    reader.onload = () => {
      ...
      const base64: string = parts[1]; // sacamos el prefijo "data:...;base64,"
      resolve(base64);
    };
...
export const uploadToImgbb = async (file: File): Promise<string> => {
  ...
  try {
    json = (await response.json()) as ImgbbResponse;
  } catch {
